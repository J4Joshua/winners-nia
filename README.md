...
**Plan** — [`docs/superpowers/plans/2026-05-09-attune-implementation-plan.md`](docs/superpowers/plans/2026-05-09-attune-implementation-plan.md) (everything: architecture, product flows, GPU compute, tasks).
